    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scattergun_coreapp.Match')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
        ...
        migrations.AddField(
            model_name='match',
            name='blue_team',
            field=models.ManyToManyField(related_name='red', to='scattergun_coreapp.Team'),
        ),
        migrations.AddField(
            model_name='match',
            name='competition',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scattergun_coreapp.Competition'),
        ),
        migrations.AddField(
            model_name='match',
            name='red_team',
            field=models.ManyToManyField(related_name='blue', to='scattergun_coreapp.Team'),
        ),
    ]
